              ...
              <div className="e-card ease-communication">
                ...
                <div className="e-card__header">
                  ...
                  <div className="e-d-flex e-align-center">
                    ...
                    <div className="e-mg-l-10">
                      <button type="button" onClick={() =>(handelSaveOrder())} className="e-btn-icon   e-bdg e-bdg-success"><i className="ri-draft-line"></i></button>
                    </div>
                  </div>
                </div>
                ...
                <div className="e-card__body e-pd-0">
                  ...
                  <div className="ease-inbox">
                    ...
                    <div className='details_total'>
                        <h4>รวมราคา : <span className=' e-fs-16 e-bdg e-bdg-danger'>฿{price2}</span> บาท</h4>
                        <h4>รวมสินค้า : <span className=' e-fs-16 e-bdg e-bdg-danger'>{qty2}</span> ชุด</h4>
                    </div>
